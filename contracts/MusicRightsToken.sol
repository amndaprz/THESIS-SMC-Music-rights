...
*/
    ...
    function transferBuyout(uint256 tokenId, uint256 totalFee, uint256 percentLabel, uint256 percentArtist, address payable artist, address payable label)payable public {
        ...
        _MRC[tokenId].client = msg.client;
