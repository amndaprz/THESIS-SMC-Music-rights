...
import {contractAddress, contractABI,contract, web3, web3S, contractStream} from '../../ContractProperties';
...
function AddStreamingContract(){
    ...
    const [streamFee, setStreamFee] = useState('');
    ...
    const handleStreamFee = (event) => { setStreamFee(event.target.value);} 
    ...
    const mintERC721Stream = async() => {
        ...
        const accounts = await web3S.eth.requestAccounts();
		account = accounts[0];
        ...
        const MRC = {
            ...
            streamFee: parseFloat(streamFee),
        };
            ...
            <div className="my-3 input_con">
                ...
                <div className="my-3 p-4 input_contract">
                    <p className="text_sub p-0 m-0">Creation date :
                        <input type="text" name="addr" className="inputfield_contract" placeholder="Type here" defaultValue={date} />
                    </p>
                </div>
                <div className="my-3 p-4 input_contract">
                    <p className="text_sub p-0 m-0">End date :
                ...
                <div className="my-3 p-4 input_contract">
                    <p className="text_sub p-0 m-0">Enter fee per stream (ETH) :
                        <input type="text" name="addr" className="inputfield_contract" placeholder="Type here" value={streamFee} onChange={handleStreamFee}/>
                    </p>
                </div>
